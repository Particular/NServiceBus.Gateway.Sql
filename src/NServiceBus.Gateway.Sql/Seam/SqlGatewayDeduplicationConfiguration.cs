...
public class SqlGatewayDeduplicationConfiguration : GatewayDeduplicationConfiguration
{
    ...
    /// </summary>
    public void ConnectionBuilder(Func<DbConnection> connectionBuilder) => this.connectionBuilder = _ => connectionBuilder();

    /// <summary>
    /// Configures a custom connection builder.
    /// </summary>
    public void ConnectionBuilder(Func<IServiceProvider, DbConnection> connectionBuilder) => this.connectionBuilder = connectionBuilder;
